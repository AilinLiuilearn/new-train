...
class SegMDTConfig(ConfigBase):
    ...
    def data_parser():
        ...
        p.add_argument("--dropout_curriculum", type=str2bool, default=True)
        p.add_argument("--dropout_warmup_epochs", type=int, default=10)
        p.add_argument("--dropout_start_prob", type=float, default=0.0)
        p.add_argument("--dropout_final_prob", type=float, default=0.4)
    ...
    def model_parser():
        ...
        p.add_argument("--text_proxy_scale", type=float, default=0.1)
        p.add_argument("--text_proxy_warmup_epochs", type=int, default=10)
        p.add_argument("--text_proxy_scale_start", type=float, default=0.0)
        p.add_argument("--text_proxy_scale_final", type=float, default=None)
