...
class SegMDTConfig(ConfigBase):
    ...
    def train_parser():
        ...
        p.add_argument('--deterministic_mode', type=str, default='balanced', choices=('off', 'balanced', 'strict'))
        p.add_argument('--assert_eval_state_unchanged', type=str2bool, default=False)
        p.add_argument('--hd95_backend', type=str, default='scipy', choices=('scipy',))
        p.add_argument('--require_pretrained', type=str2bool, default=True)
        p.add_argument('--minimum_pretrained_element_coverage', type=float, default=0.90)
