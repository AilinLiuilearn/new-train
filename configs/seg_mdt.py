...
class SegMDTConfig(ConfigBase):
    ...
    def model_parser():
        ...
        p.add_argument('--use_tgtu_fusion', type=str2bool, default=True)
        p.add_argument('--tgtu_use_text', type=str2bool, default=True)
        p.add_argument('--tgtu_use_turr_loss', type=str2bool, default=True)
        p.add_argument('--tgtu_turr_interval', type=int, default=5)
