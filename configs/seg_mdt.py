...
class SegMDTConfig(ConfigBase):
    ...
    def model_parser():
        ...
        p.add_argument('--pspi_bank_update_mode', type=str, default='matched_ema', choices=('direct', 'matched_ema', 'fedmepd_ema'))
        ...
        # Module-2: StateTextDetailFrequencyFusion downstream fusion (replaces AddFusion).
        ...
        p.add_argument('--module2_frequency_sigma', type=float, default=0.15)
