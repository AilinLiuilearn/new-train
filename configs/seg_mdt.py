...
class SegMDTConfig(ConfigBase):
    ...
    def model_parser():
        ...
        p.add_argument('--use_ssppc', type=str2bool, default=True)
        p.add_argument('--ssppc_outlier_ratio', type=float, default=0.05)
        p.add_argument('--ssppc_cache_on_cpu', type=str2bool, default=True)
        p.add_argument('--ssppc_vis_num_samples', type=int, default=1)
