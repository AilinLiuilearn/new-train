...
class SegMDTConfig(ConfigBase):
    ...
    def model_parser():
        ...
        p.add_argument('--decoder_channels', type=int, nargs=4, default=[256, 128, 64, 32])
        p.add_argument('--joint_full_weight', type=float, default=0.5)
        p.add_argument('--joint_missing_weight', type=float, default=0.5)
        p.add_argument('--enable_gradient_diagnostics', type=str2bool, default=True)
        p.add_argument('--gradient_diagnostics_interval', type=int, default=5)
        p.add_argument('--gradient_diagnostics_num_batches', type=int, default=1)
        return p
    ...
    def train_parser():
        ...
        p.add_argument('--checkpoint_dir', type=str, default='./checkpoints_new/MDT/e1-clean-joint-baseline')
