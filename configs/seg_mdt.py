...
class SegMDTConfig(ConfigBase):
    ...
    def train_parser():
        ...
        p.add_argument('--train_mode', type=str, default='within_batch_alternating', choices=('within_batch_alternating', 'legacy_batch_alternating'))
        p.add_argument('--within_batch_full_weight', type=float, default=0.5)
        p.add_argument('--within_batch_missing_weight', type=float, default=0.5)
        p.add_argument('--within_batch_cosine_diagnostics', type=str2bool, default=False)
        p.add_argument('--within_batch_cosine_every', type=int, default=100)
        p.add_argument('--within_batch_cosine_samples', type=int, default=2)
