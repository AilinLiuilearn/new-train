...
class SegMDTConfig(ConfigBase):
    ...
    def model_parser():
        ...
        p.add_argument('--pspi_affine_enabled', type=str2bool, default=True)
        ...
        # Module-2: downstream probabilistic PET/CT fusion (replaces AddFusion)
        p.add_argument('--fusion2_enabled', type=str2bool, default=False)
        p.add_argument('--fusion2_text_enabled', type=str2bool, default=False)
        p.add_argument('--fusion2_text_cache', type=str, default=None)
        p.add_argument('--fusion2_text_width', type=int, default=32)
        p.add_argument('--fusion2_text_strength', type=float, default=0.5)
        p.add_argument('--fusion2_reliability_min', type=float, default=0.2)
        p.add_argument('--fusion2_sigma_init', type=float, default=1.5)
        p.add_argument('--fusion2_logvar_bounds', type=float, nargs=2, default=[-10.0, 10.0])
    ...
    def train_parser():
        ...
        p.add_argument('--train_batch_mode', type=str, default='mixed', choices=('alternating', 'mixed'))
