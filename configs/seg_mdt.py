...
class SegMDTConfig(ConfigBase):
    ...
    def model_parser():
        ...
        p.add_argument('--asym_use_text', type=str2bool, default=True)
        p.add_argument('--asym_clip_path', type=str, default='pretrained/clip-vit-base-patch32')
        p.add_argument('--asym_checkpoint_attention', type=str2bool, default=False)
