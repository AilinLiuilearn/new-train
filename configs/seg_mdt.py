...
class SegMDTConfig(ConfigBase):
    ...
    def model_parser():
        ...
        p.add_argument('--model_arch', type=str, default='dual_shared_add_baseline', choices=('dual_shared_add_baseline', 'dual_shared_add_fgms_stage2'))
        p.add_argument('--stage1_checkpoint', type=str, default=None)
        p.add_argument('--fgms_expert_dim', type=int, default=128)
        p.add_argument('--fgms_num_experts', type=int, default=6)
        p.add_argument('--fgms_top_k', type=int, default=2)
        p.add_argument('--fgms_enable_balance_loss', type=str2bool, default=True)
        p.add_argument('--fgms_balance_loss_weight', type=float, default=0.1)
        p.add_argument('--fgms_residual_mode', type=str, default='zero_start', choices=('zero_start', 'paper'))
        p.add_argument('--fgms_progressive_coadapt', type=str2bool, default=True)
        p.add_argument('--fgms_decoder_unfreeze_epoch', type=int, default=2)
        p.add_argument('--fgms_boundary_unfreeze_epoch', type=int, default=4)
        p.add_argument('--stage1_boundary_lr', type=float, default=5e-6)
