...
def build_mdt_seg_teacher(config):
    ...
    if model_arch == 'dual_decoder_multiscale_task_increment_bank':
        ...
        print(
            ...
            f'full_query_source=difference_conditioned_joint difference_cue=abs(channel_l2norm_CT-channel_l2norm_PET) '
            f'difference_condition=residual_zero_init missing_query_source=CT bank_trainable_on_full=True '
