...
def load_local_weights_safe(model, path, name='Encoder'):
    ...
    if os.path.isdir(path):
        found = False
        for cand in ('pytorch_model.bin', 'model.safetensors', 'pvt_v2_b1.pth', 'pvt_v2_b1.bin', 'pvt_v2_b1.pt'):
...
class DualPVTB1LightUNet(nn.Module):
    """Dual CT/PET PVTv2-B1 teacher with lightweight additive UNet decoder."""
